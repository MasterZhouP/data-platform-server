-- User-supplied DEE source SQL, 2026-09-07.
-- Migration evidence only; not a runnable platform query resource.
-- Formatting and Markdown escaping normalized; original query rules retained.
SELECT *
FROM (
    SELECT
        ch.iinvweight jz,
